...
class ChallongeAPI {
  ...
  */
  public function makeCall($path='', $params=array(), $method='get') {
    ...
    $call_url = "https://api.challonge.com/v1/".$path.'.'.$this->format;
      ...
      switch ($this->status_code) {
        ...
        case 422: // Validation errors
          if($this->format == 'xml'){
            ...
            $return = $this->result = json_decode($curl_result);
          }
        ...
        case 404: // Not found!
          ...
          $this->errors[] = "Could not find the page: " . $call_url;
          break;
  ...
  public function startTournament($tournament_id, $params=array()) {
    return $this->makeCall("tournaments/$tournament_id/start", $params, "post");
  }

  public function resetTournament($tournament_id, $params=array()) {
    return $this->makeCall("tournaments/$tournament_id/reset", $params, "post");
  }
